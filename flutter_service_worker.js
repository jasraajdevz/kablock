...
// worker + all caches a returning device may still have, then unregister itself
// so the browser always fetches the freshest build.
//
// Bump KILL_VERSION on every deploy so returning devices re-run activate().
const KILL_VERSION = 'v24-2026-07-31';
